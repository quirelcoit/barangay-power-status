...
VALUES
  ...
  ((SELECT id FROM public.barangays WHERE name = 'Bautista' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Bautista', 247),
  ((SELECT id FROM public.barangays WHERE name = 'Calaocan' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Calaocan', 85),
  ((SELECT id FROM public.barangays WHERE name = 'Dabubu Grande' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Dabubu Grande', 429),
  ((SELECT id FROM public.barangays WHERE name = 'Dabubu Pequeño' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Dabubu Pequeño', 183),
  ((SELECT id FROM public.barangays WHERE name = 'Dappig' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Dappig', 169),
  ((SELECT id FROM public.barangays WHERE name = 'Laoag' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Laoag', 282),
  ((SELECT id FROM public.barangays WHERE name = 'Mapalad' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Mapalad', 362),
  ((SELECT id FROM public.barangays WHERE name = 'Palacian' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Palacian', 325),
  ((SELECT id FROM public.barangays WHERE name = 'Panang' AND municipality = 'SAN AGUSTIN, ISABELA' LIMIT 1), 'SAN AGUSTIN, ISABELA', 'Panang', 201),
