            ...
            >
              ...
              {filteredReports.map((report) => (
                ...
                >
                  ...
                  >
                    <div className="w-full xs:min-w-64 sm:min-w-80 md:min-w-96 p-3 xs:p-4 sm:p-5 space-y-3">
                      {/* Title */}
                      <h3 className="font-bold text-lg xs:text-xl sm:text-2xl text-gray-900 leading-tight">
                        {CATEGORY_COLORS[report.category]?.label ||
                          report.category}
                      </h3>

                      {/* Location - prominent */}
                      <div className="p-2 xs:p-3 sm:p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
                        <p className="text-sm xs:text-base sm:text-lg font-semibold text-gray-900 break-words">
                      ...
                      {report.description && (
                        <div>
                          <p className="text-xs xs:text-sm sm:text-base font-semibold text-gray-600 mb-2">
                            Description:
                          </p>
                          <p className="text-sm xs:text-base sm:text-lg text-gray-700 bg-gray-50 p-2 xs:p-3 rounded break-words">
                            "{report.description}"
                          </p>
                        </div>
                      )}
                      ...
                      {/* Timestamp */}
                      <div className="text-xs xs:text-sm sm:text-base text-gray-500 border-t border-gray-200 pt-2">
                      ...
                      {isAdmin && (
                        <button
                          ...
                          className="w-full mt-2 px-3 xs:px-4 py-2 xs:py-3 sm:py-4 bg-red-50 text-red-700 border border-red-200 rounded-lg hover:bg-red-100 transition-colors text-xs xs:text-base sm:text-lg font-semibold flex items-center justify-center gap-2"
                        >
                          <Trash2 className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6" />
                          Delete Report
                        </button>
                      )}
                    </div>
